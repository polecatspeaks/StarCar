...
|---|---|---|
| `dispatched` | `PostToolUse` matcher `Task` | Fires at launch, `status: async_launched`, no body - `artifacts/reviews/2026-07-22-harness-design-round1-REJECT.md`'s MAJOR-1 finding (cited by heading, not line - see the same citation's fuller note in `docs/design/2026-07-22-dispatch-harness-design.md`'s equivalent row) |
