...
| 07-22 | GitNexus stale-index warning fires on every Bash call, for an index belonging to another project. StarCar has no code to index yet. | Continuous noise | Cross-project tooling leak |
