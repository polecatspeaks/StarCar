...
| Landed verdicts | `docs/reviews/` | **Seven** design-review verdicts, verbatim and hash-verified (`Verify-Verdict.ps1`, also run by CI). The harness design proposes retiring this directory in favour of a single artifact store; until that lands, this is where verdicts live. |
