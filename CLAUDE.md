...
This project is indexed by GitNexus as **StarCar** (1932 symbols, 3002 relationships, 60 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
